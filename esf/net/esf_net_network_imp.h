...
#ifndef __ESF_NET_NETWORK_IMP_H__
#define __ESF_NET_NETWORK_IMP_H__

#include <set>

#include "esf_net_sock.h"
...
public:
	...
	virtual void AttachFD(int fd){_socket.attach(fd);_socket.set_nonblock();}
